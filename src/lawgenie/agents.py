...
task1 = Task(
    description="Flag if the contract is for duration not equal to the vendor's desired duration",
...
crew = Crew(agents=[contract_duration_agent], tasks=[task1], verbose=True)
